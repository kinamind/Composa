/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 94211b4d0ebed887029e13c759df6b8f)
...
interface __BaseEnv_Env {
	...
	XHS_COOKIE: string;
	COMPOSA_AGENT: DurableObjectNamespace<import("./src/index").ComposaAgent>;
	REMINDER_WORKFLOW: Workflow<Parameters<import("./src/index").ReminderWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ComposaAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_LOCALE" | "TIMEZONE" | "DAILY_PLAN_TIME" | "AI_EMBEDDING_MODEL" | "AI_MAX_TOKENS" | "AI_TIMEOUT_MS" | "AI_DAILY_PLAN_TIMEOUT_MS" | "AI_DAILY_REQUEST_LIMIT" | "URL_FETCH_TIMEOUT_MS" | "URL_MAX_TEXT_BYTES" | "MEDIA_MAX_BYTES" | "XHS_MAX_BYTES" | "QQ_API_BASE_URL" | "AI_API_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_WEBHOOK_SECRET" | "QQ_APP_SECRET" | "ADMIN_API_TOKEN" | "XHS_COOKIE">> {}
}
declare module "*.md" {
	const value: string;
